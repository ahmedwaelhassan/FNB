...
class loan extends StatefulWidget {
  ...
  @override
  State<loan> createState() => loanState(Email: Email, Password: Password, username: username, mobile: mobile, Gender: Gender, dob: dob, id: id, Adress: Adress, nationalid: nationalid);
}
